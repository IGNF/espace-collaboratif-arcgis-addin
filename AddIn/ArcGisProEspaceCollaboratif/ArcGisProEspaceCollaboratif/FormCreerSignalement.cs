...
namespace ArcGisProEspaceCollaboratif
{
    public partial class FormCreerSignalement : Form
    {
        ...
        public FormCreerSignalement()
        {
            ...
            this.toolTip.SetToolTip(this.checkedListBoxThemes, "Sélectionnez les thèmes auxquels vous souhaitez assosier la nouvelle remarque.");
            this.toolTip.SetToolTip(this.richTextBoxMessage, "Rédigez ici le message pour la nouvelle remarque Ripart.");
            this.toolTip.SetToolTip(this.buttonCreer, "Créer la nouvelle remarque.\n Nécéssite au moins qu'un thème soit associé et un message ait été rédigé.");

        }

        /// <summary>
        /// Remplit le formulaire FormCreerEspaceCollaboratif avant son utilisation.
        /// </summary>         
        /// <param name="nbrRemarque">Le nombre de remarques Ripart à créer si l'option de création d'une unique remarque n'est pas choisie.</param>
        ...
        public void SetFormulaire(int nbrRemarque, Contexte contexte, ArcGisProEspaceCollaboratif.Core.IClient iclient)
        {
            ...
            if (nbrRemarque == 1)
            {
                this.radioButtonRemarqueMultiple.Enabled = false;
                this.radioButtonRemarqueMultiple.Visible = false;
                this.radioButtonRemarqueUnique.Visible = false;

            }
            else
            {
                this.radioButtonRemarqueMultiple.Enabled = true;
                this.radioButtonRemarqueMultiple.Visible = true;
                this.radioButtonRemarqueMultiple.Text = "Créer " + nbrRemarque + " remarques distinctes.";
            }
        ...
        /// <summary>
        ///  Événement après doubleclick sur un fichier mis en pièce-jointe pour le retirer.
        /// </summary>  
        ...
        /// <summary>
        ///  Affiche dans le formulaire FormCreerEspaceCollaboratif le fichier sélectionné en pièce-jointe avec son icône associé.
        /// </summary>  
        ...
        /// <summary>
        /// Présélectionné les thèmes dans le formulaire FormCreerEspaceCollaboratif à partir des thèmes préférés indiqués dans le fichier XML de paramétrage.
        /// </summary>        
        ...
        /// <summary>
        /// Indique si l'option de création d'une remarque unique a été choisie dans le formulaire FormCreerEspaceCollaboratif.
        /// </summary>  
        /// <returns>True si l'option de création d'une remarque unique est activée.</returns>
        public bool OptionSingleRemarque()
        {
            return this.radioButtonRemarqueUnique.Checked;
        }

        /// <summary>
        /// Le message saisi dans le formulaire FormCreerEspaceCollaboratif et à affecter dans la nouvelle remarque de l'Espace collaboratif.
        /// </summary>  
        /// <returns>Le message saisi pour la nouvelle remarque Ripart.</returns>
        ...
        /// <summary>
        /// Les thèmes sélectionnés dans le formulaire FormCreerEspaceCollaboratif et à affecter à la nouvelle remarque Ripart.
        /// </summary>  
        /// <param name="profil">Le profil du rédacteur de la nouvelle remarque Ripart et qui contient les thèmes pour lesquels il peut y contribuer.</param>
        /// <returns>La liste des thèmes à affecter à la nouvelle remarque Ripart.</returns>
        ...
        /// <summary>
        /// Décompte les thèmes qui sont sélectionnés dans le formulaire FormCreerEspaceCollaboratif.
        /// </summary>         
        ...
        /// <summary>
        /// Indique si des thèmes sont sélectionnés dans le formulaire FormCreerEspaceCollaboratif.
        /// </summary>         
        /// <returns>True s'il y a un moins un thèmes sélectionnés dans le formulaire.</returns>
        ...
        /// <summary>
        /// Donne la liste des fichiers sélectionnés dans le formulaire FormCreerEspaceCollaboratif et à mettre en pièce-jointe dans la nouvelle remarque Ripart à créer.
        /// </summary>         
        /// <returns>Liste du chemin d'accès complèt de chaque fichier choisi comme pièce-jonte.</returns>
        ...
        /// <summary>
        ///  Indique si l'option de joindre un croquis Ripart à la nouvelle remarque Ripart qu'on veut créer, a été choisie dans le formulaire FormCreerEspaceCollaboratif.
        /// </summary>         
        ...
        /// <summary>
        ///  Action après click-souris sur la liste des thèmes dans le formulaire FormCreerEspaceCollaboratif. 
        /// </summary>  
        ...
        /// <summary>
        ///  Action après changement dans l'option de joindre un fichier dans le formulaire FormCreerEspaceCollaboratif. 
        /// </summary>  
        private void checkBoxDocument_CheckedChanged(object sender, EventArgs e)
        {
            ...
            // Procédure de sélection du document à joindre à la nouvelle remarque.
            if (this.checkBoxDocument.Checked)
            {
                ...
                { // Si un fichier est bien choisi.
                    ...
                    // Vérification du format du fichier (exclusion des formats potentiellement malveillant)

                    if (extension.Equals(".php") || extension.Equals(".exe") || extension.Equals(".dll"))
                    {
                        System.Windows.Forms.MessageBox.Show("Les fichiers de type ''" + fichierPJ.Extension + "'' ne sont pas autorisées comme pièce-jointe dans le service Ripart.", "IGN Ripart", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Stop);
                    ...
                    { // Vérification si le fichier a une taille acceptable pour le service Ripart.

                        if (fichierPJ.Length > this.maxSizePJ)
                        {
                            System.Windows.Forms.MessageBox.Show("Le fichier ''" + fichierPJ.FullName + "'' ne peut être envoyé au service de l'Espace collaboratif, car sa taille (" + fichierPJ.Length / 1024 + " Ko) dépasse celle maximalle autorisée. (" + this.maxSizePJ / 1024 + " Ko)", "IGN Espace collaboratif", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Stop);
        ...
        /// <summary>
        ///  Action après modification du message dans formulaire FormCreerEspaceCollaboratif. 
        /// </summary>  
